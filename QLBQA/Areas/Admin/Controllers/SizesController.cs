...
namespace QLBQA.Areas.Admin.Controllers
{
    ...
    public class SizesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SizeID,SizeName,Description")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SizeID,SizeName,Description")] Size size)
        {
            if (ModelState.IsValid)
            {
