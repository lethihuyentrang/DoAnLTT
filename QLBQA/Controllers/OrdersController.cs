...
namespace QLBQA.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderID,CustomerID,OrderDate,ShipDate,TransactStatusID,Deleted,Paid,PaymentDate,PaymentID,Note")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,CustomerID,OrderDate,ShipDate,TransactStatusID,Deleted,Paid,PaymentDate,PaymentID,Note")] Order order)
        {
            if (ModelState.IsValid)
            {
